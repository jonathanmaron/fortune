...
return [
    '7081f546-f224-569e-8071-222ea1e8d3f8' => [
        'Even a smile is a good deed.',
        'Shari Arison',
    ],
    '7081f961-5d6a-564d-8ab4-f6de632d6efa' => [
        'You can\'t trust without risk but neither can you live in a cocoon.',
        'Byron Pulsifer',
    ],
    '7082fffd-9a74-5d65-bd4f-35e48edf79d0' => [
        'Fear not for the future, weep not for the past.',
        'Percy Shelley',
    ],
    '7110c7ac-5060-5c35-b02c-9a8281202715' => [
    ...
    '07156dc0-3a96-5573-ac9d-a562d298c99e' => [
    ...
    '7158debe-f8cd-579a-b302-1ec3a1796a8b' => [
        'There is the sky, which is all men\'s together.',
        'Euripides',
    ],
    '7166a2fc-c47d-5291-9dcf-c73ed1fe9435' => [
        'Mozart\'s music is so pure and beautiful that I see it as a reflection of the inner beauty of the universe.',
        'Albert Einstein',
    ],
    '7170eca1-31cc-5206-8ca8-5a15ccb7fa7e' => [
        'Let us change our traditional attitude to the construction of programs. Instead of imagining that our main task is to instruct a computer what to do, let us concentrate rather on explaining to human beings what we want a computer to do.',
        'Donald Knuth',
    ],
    '7171f0df-1ce2-5066-9475-e8f91ee368ff' => [
        'I was motivated to be different in part because I was different.',
        'Donna Brazile',
    ],
    '7177a21d-cc72-5de6-9d5c-21625e55d0ad' => [
        'Wisdom begins in wonder.',
        'Socrates',
    ],
    '7181daf3-59a4-5bce-a499-cabc2d25d600' => [
    ...
    '7208b47d-76ff-5647-a430-780cc0ab01ff' => [
        'People in tough times - it doesn\'t mean they don\'t have a great attitude.',
        'Joel Osteen',
    ],
    '7210fca6-15c7-52c7-9c8f-211269642fa4' => [
    ...
    '7282c65a-f718-51ed-a605-5ce337702b95' => [
        'I got attention by being funny at school, pretending to be retarded, and jumping around with a deformed hand.',
        'Leonardo DiCaprio',
    ],
    '7282f3d1-186a-5838-94e7-b148dfc54a6b' => [
    ...
    '7289b4a9-38cc-5900-acd7-1b58fb3c2898' => [
    ...
    '7295ecf3-4680-57aa-a643-295f78d0dace' => [
        'Mistakes are a part of being human. Appreciate your mistakes for what they are: precious life lessons that can only be learned the hard way. Unless it\'s a fatal mistake, which, at least, others can learn from.',
        'Robert Baden-Powell',
    ],
    '7300c19b-7690-5769-a01d-9a8627d068d9' => [
        'What is government itself but the greatest of all reflections on human nature?',
        'James Madison',
    ],
    '7303edbb-4673-5c58-8cf2-956f093d67a0' => [
    ...
    '7311c1a3-0eb4-5d27-ae53-cf77d5159459' => [
    ...
    '7335e46e-9f03-52e7-b6a0-6522c555a4c3' => [
        'Beware the barrenness of a busy life.',
        'Swami Vivekananda',
    ],
    '7356e0e0-9e14-5108-b5c9-e9f9378e0efe' => [
        'Almost everything comes from nothing.',
        'Henri Amiel',
    ],
    '7356fc97-6393-58a9-a8d7-8a125667fc69' => [
        'We must not say every mistake is a foolish one.',
        'Cicero',
    ],
    '7371e5a2-df39-5111-9cab-a370af500506' => [
        'The best thing in every noble dream is the dreamer...',
        'Moncure Conway',
    ],
    '7424e6a5-fcd5-5a14-9445-0a808b250f4d' => [
        'I try to make people smile and dance, not think about things or educate them.',
        'Norman Cook',
    ],
    '7435b9c6-0f92-5cd2-b7f3-50e28ed1976f' => [
    ...
    '7471b630-a24f-5399-b993-16c5457e3e44' => [
        'Do the one thing you think you cannot do. Fail at it. Try again. Do better the second time. The only people who never tumble are those who never mount the high wire. This is your moment. Own it.',
        'Oprah Winfrey',
    ],
    '7485c305-a50d-54e7-91ee-f7ba60ac2c4f' => [
        'After a lifetime of world travel I\'ve been fascinated that those in the third world don\'t have the same perception of reality that we do.',
        'Jim Harrison',
    ],
    '7502d2d9-d3af-5b3c-954c-c5b0f1193705' => [
    ...
    '7534b3ea-e43a-56e2-a1ed-a2c492bde209' => [
    ...
    '7544fd46-0579-5ae6-b0e1-0867d61f5196' => [
    ...
    '7565f8e8-527b-5f85-82d7-424cf77e5303' => [
        'Success depends almost entirely on how effectively you learn to manage the game\'s two ultimate adversaries: the course and yourself.',
        'Jack Nicklaus',
    ],
    '07570ccf-ad61-5cad-9911-335755ec3b3d' => [
    ...
    '7580e153-e9d9-5c1a-b178-5cf4ffe7b6c1' => [
    ...
    '7599bb9a-4fda-55d2-9d30-7a2b6bc0ad71' => [
        'Sweat, sweat, sweat! Work and sweat, cry and sweat, pray and sweat!',
        'Zora Neale Hurston',
    ],
    '7600e2b9-3911-5125-89fd-2e0d217af6ec' => [
    ...
    '7609bf97-b5f0-5b72-b50f-aab7e439372d' => [
    ...
    '7632e99c-ee86-54ab-b37a-dd1e083c5b46' => [
        'The secret to doing anything is believing that you can do it. Anything that you believe you can do strong enough, you can do. Anything. As long as you believe.',
        'Bob Ross',
    ],
    '7647d947-bc25-500c-9dfd-b028cc9b5dd7' => [
        'Life was a funny thing that happened to me on the way to the grave.',
        'Quentin Crisp',
    ],
    '7650ad21-772d-59d6-91d1-c9ec2f6e5a01' => [
        'The best liar is he who makes the smallest amount of lying go the longest way.',
        'Samuel Butler',
    ],
    '7661b5f9-2484-5706-8918-8138f2a3c058' => [
        'I always had a fantasy of being a chef, because I like kitchen life.',
        'Harvey Mackay',
    ],
    '7662cc5b-bf35-53e0-84b0-2a418a12dbc3' => [
    ...
    '7662d507-aee5-55ee-9917-2b5d2473e598' => [
    ...
    '7667cf75-287f-580b-bc89-0fc03bf5d0a0' => [
    ...
    '7686d6d2-1f99-576f-b455-0072fb9d999b' => [
    ...
    '7694e628-0e44-5d01-8a64-5e3a03ed42c9' => [
        'There are powers inside of you which, if you could discover and use, would make of you everything you ever dreamed or imagined you could become.',
        'Orison Swett Marden',
    ],
    '7699f4ed-1ed4-5ff9-8f3d-d3d5f313122c' => [
    ...
    '7707e26a-f993-536e-9ca6-880953864723' => [
        'When you travel, remember that a foreign country is not designed to make you comfortable. It is designed to make its own people comfortable.',
        'Clifton Fadiman',
    ],
    '7734f39d-2a7a-5810-af3a-f579f8aad81f' => [
        'Beauty, like truth, is relative to the time when one lives and to the individual who can grasp it. The expression of beauty is in direct ratio to the power of conception the artist has acquired.',
        'Gustave Courbet',
    ],
    '7748adf1-7e19-574a-a92b-ad8fede3c708' => [
    ...
    '7905d32f-2c46-5bfe-a316-c2674a953d19' => [
        'Consider a tree for a moment. As beautiful as trees are to look at, we don\'t see what goes on underground - as they grow roots. Trees must develop deep roots in order to grow strong and produce their beauty. But we don\'t see the roots. We just see and enjoy the beauty. In much the same way, what goes on inside of us is like the roots of a tree.',
        'Joyce Meyer',
    ],
    '7905ee70-58ab-51f8-a874-4dbb5acf268d' => [
        'It is the nature of babies to be in bliss.',
        'Deepak Chopra',
    ],
    '7928d7e6-0060-5c97-ab81-20e0f118baa1' => [
    ...
    '7940f85b-245a-5652-a1ed-248da6ac2e05' => [
        'We sometimes laugh from ear to ear, but it would be impossible for a smile to be wider than the distance between our eyes.',
        'Malcolm de Chazal',
    ],
    '7941badd-f49b-5d09-8b16-c2d4eecad504' => [
    ...
    '8031c706-251f-59b5-9c6d-1a20c6e51092' => [
        'Life is made up of sobs, sniffles, and smiles, with sniffles predominating.',
        'Diane von Furstenberg',
    ],
    '8034abed-673a-5e91-8956-fe30043154fe' => [
    ...
    '8041c2e3-d0ee-5da2-911c-65c6b4db7698' => [
    ...
    '8066f5c6-d8cd-55dd-9894-c546d059282f' => [
        'A man is great by deeds, not by birth.',
        'Chanakya',
    ],
    '08069b60-100a-5ecd-867b-fd89cae0afc9' => [
        'Dad kept us out of school, but school comes and goes. Family is forever.',
        'Charlie Sheen',
    ],
    '8093aaf4-bad8-5991-9f95-bd0c8493e9ab' => [
        'Success is to be measured not so much by the position that one has reached in life as by the obstacles which he has overcome.',
        'Booker T. Washington',
    ],
    '8110d4d0-d29f-5a3a-9010-e3e8f2e490bd' => [
        'To give pain is the tyranny; to make happy, the true empire of beauty.',
        'Samuel Butler',
    ],
    '8113c519-b213-51fe-9ec4-7e206716d1b9' => [
    ...
    '08158c67-0b1c-5ddc-b7a8-4ac93f949c51' => [
    ...
    '8197c935-3049-54d9-b8bd-63cefe753044' => [
        'Success is a state of mind. If you want success, start thinking of yourself as a success.',
        'Joyce Brothers',
    ],
    '8201c2f0-cad6-557a-a545-3b45ad9805e4' => [
    ...
    '8215b214-9cc1-5abb-86e4-21ebf6816087' => [
        'The genius of the United States is not best or most in its executives or legislatures, nor in its ambassadors or authors or colleges, or churches, or parlors, nor even in its newspapers or inventors, but always most in the common people.',
        'Walt Whitman',
    ],
    '08227f77-e866-5d01-9e8f-e8b5b6c8dce1' => [
    ...
    '8322ebb7-54d0-5229-9ee6-7f5c5591fd15' => [
        'The regret of my life is that I have not said \'I love you\' often enough.',
        'Philip Emeagwali',
    ],
    '8322f979-db22-5414-8836-82c428bb888a' => [
    ...
    '8347e342-f8f3-5d1c-bd7a-f9438720da06' => [
        'You measure the size of the accomplishment by the obstacles you had to overcome to reach your goals.',
        'Booker T. Washington',
    ],
    '8355e023-7952-5332-a06f-6c3eeb393062' => [
        'They can conquer who believe they can.',
        'Virgil',
    ],
    '008382cb-7df7-56f9-8a25-1effe4e4f8dd' => [
        'Work is love made visible. And if you cannot work with love but only with distaste, it is better that you should leave your work and sit at the gate of the temple and take alms of those who work with joy.',
        'Khalil Gibran',
    ],
    '8418ad24-f925-5d96-8a39-b1bcc8802dc9' => [
        'My brother is my best friend.',
        'Erinn Smart',
    ],
    '8442d69d-feb4-5fa9-b060-b4b370939d75' => [
        'I am glad that I paid so little attention to good advice; had I abided by it I might have been saved from some of my most valuable mistakes.',
        'Edna Millay',
    ],
    '8453b04c-5daf-506a-b38a-343470ab6ef3' => [
    ...
    '8459de22-d387-5adb-b08e-8014ab67cfb0' => [
    ...
    '8466bbc9-cc87-5d7f-b4ee-3414dd2bb1aa' => [
    ...
    '8482cfec-72b9-5aca-91ef-9d34d0bb59bd' => [
    ...
    '8484a769-1722-5c0b-8606-bbbb6ad54c13' => [
    ...
    '8497b9de-35af-5e31-8e02-ed31fe8783b6' => [
    ...
    '8556e9bd-5c35-5663-88c4-aeb92716d430' => [
        'San Francisco is a mad city - inhabited for the most part by perfectly insane people whose women are of a remarkable beauty.',
        'Rudyard Kipling',
    ],
    '8581ea01-2d77-578c-8246-bf677e28d778' => [
        'It\'s fun to have a partner who understands your life and lets you be you.',
        'Ann Landers',
    ],
    '8604dfef-b89b-50cc-bed0-dea0cbb2874d' => [
        'No man should bring children into the world who is unwilling to persevere to the end in their nature and education.',
        'Plato',
    ],
    '8609fb53-94e7-5d80-ba3d-66d2eab18f7d' => [
    ...
    '8631fdef-40bb-5e12-bcfc-3b24a45c44ee' => [
    ...
    '08708db4-ea55-56b9-813b-d654e507b333' => [
    ...
    '8734ae78-5dc3-59ec-bd2e-069fa17f4069' => [
    ...
    '8736a98b-c810-5394-ae38-f44307880577' => [
        'It is better to keep your mouth closed and let people think you are a fool than to open it and remove all doubt',
        'Mark Twain',
    ],
    '8747e2f1-3e99-51ca-a973-7f65fa85d6de' => [
        'Maybe nature is fundamentally ugly, chaotic and complicated. But if it\'s like that, then I want out.',
        'Steven Weinberg',
    ],
    '8749ed53-ae77-5a40-8f96-f46aa3438aba' => [
        'The single biggest surprise about arriving to the Senate is the defeatist attitude here.',
        'Ted Cruz',
    ],
    '8774e414-1b2c-5e20-928e-0501b2fcee9a' => [
    ...
    '8775fbba-6387-5842-a662-3edb653c926e' => [
        'External nature is only internal nature writ large.',
        'Swami Vivekananda',
    ],
    '8776e80f-b252-5950-be71-fa0889529c2a' => [
    ...
    '8783ea93-97a1-5813-809c-8a0c5feddc70' => [
        'Difficulties are meant to rouse, not discourage. The human spirit is to grow strong by conflict.',
        'William Channing',
    ],
    '8789dadc-a63a-5821-bda7-5dc67453f112' => [
        'No pessimist ever discovered the secret of the stars, or sailed to an uncharted land, or opened a new doorway for the human spirit.',
        'Helen Keller',
    ],
    '8791e5b0-a7c4-58a7-acec-12030637a5b5' => [
    ...
    '8794a9f2-a6ff-5b8b-8aa5-3704094879ac' => [
    ...
    '8811da29-2005-5ee5-b77d-85b4b8d89945' => [
        'Time moves in one direction, memory in another.',
        'William Gibson',
    ],
    '8822f1b5-95dd-5e51-bf68-40d7445a836a' => [
        'When I was doing ensemble theater and comedy work, I felt I had some talents. But when I started doing my shows in Berkeley and found that I could be funny on my own, I was shocked.',
        'Whoopi Goldberg',
    ],
    '8836c4a1-a27b-542c-b181-2dc6bdd06b03' => [
        'Common sense would suggest that having ability, like being smart, inspires confidence. It does, but only while the going is easy. The deciding factor in life is how you handle setbacks and challenges. People with a growth mindset welcome setbacks with open arms.',
        'Ezra Taft Benson',
    ],
    '8842a3f4-acf2-5264-a0be-492fd7cb5d8a' => [
    ...
    '8860bbd2-f295-5137-97f8-9751a9307a67' => [
        'Be great in act, as you have been in thought.',
        'William Shakespeare',
    ],
    '8863c9e9-5be0-560e-8b5f-13fb3f704422' => [
    ...
    '8870db57-9ecc-5b57-afcc-54a7bfa4f621' => [
    ...
    '8892c3eb-0c96-5ac3-9ede-3703a28065a5' => [
        'Work is the meat of life, pleasure the dessert.',
        'B. C. Forbes',
    ],
    '8897beba-e2f3-5f20-b80f-231fbf0a9e18' => [
        'All growth depends upon activity. There is no development physically or intellectually without effort, and effort means work.',
        'Calvin Coolidge',
    ],
    '8899b820-5c1e-5308-8f5c-8f70762373e4' => [
        'I need to be cheered up a lot. I think funny people are people who need to be cheered up.',
        'Lynda Barry',
    ],
    '8901e821-578f-5396-8cad-e6cbd5d14d57' => [
        'The traveller has reached the end of the journey!',
        'Edmund Burke',
    ],
    '8922c211-4e97-57f8-b46d-ba72093938ee' => [
        'Men are liars. We\'ll lie about lying if we have to. I\'m an algebra liar. I figure two good lies make a positive.',
        'Tim Allen',
    ],
    '8939f89a-6b64-5b0c-9dcc-6e9a9e457d85' => [
        'I always loved aesthetics. Not particularly fashion, but an idea of beauty.',
        'Miuccia Prada',
    ],
    '8943acf2-49a4-59a0-8d43-4714bf927e4e' => [
    ...
    '8957f011-db29-57a0-adb9-28b07578934d' => [
        'Nothing is worth more than this day.',
        'Johann Wolfgang von Goethe',
    ],
    '08966c4a-a3ea-5e07-ac13-3c914580c957' => [
        'In all things of nature there is something of the marvelous.',
        'Aristotle',
    ],
    '8972d20e-4afa-546c-8f87-944ea3a498ba' => [
        'Pray that success will not come any faster than you are able to endure it.',
        'Elbert Hubbard',
    ],
    '8975f41a-ce25-55e0-bd32-4914d289326a' => [
        'Success consists of getting up just one more time than you fall.',
        'Oliver Goldsmith',
    ],
    '8978f2e4-a2c8-53f9-b3ae-49e8e82d73d8' => [
    ...
    '8993c096-e8b2-5f5f-9a23-eeecee212196' => [
    ...
    '8997d1f8-c7c7-5796-b81d-eddafc882beb' => [
    ...
    '9024f7bc-448d-55c6-ae77-72da4d471fd4' => [
    ...
    '9035c04c-c5d0-5cb2-b7ba-445f0939fdbd' => [
        'A beautiful thing is never perfect.',
        'Unknown',
    ],
    '9038fe93-a335-5757-a6f4-9e502a2c5332' => [
        'The key to success is to focus our conscious mind on things we desire not things we fear.',
        'Brian Tracy',
    ],
    '9049d465-d4d9-5935-89a7-7222ac29c253' => [
        'Fate is in your hands and no one elses',
        'Byron Pulsifer',
    ],
    '09071a23-d57c-5aec-9991-ac912163e906' => [
        'Nature holds the key to our aesthetic, intellectual, cognitive and even spiritual satisfaction.',
        'E. O. Wilson',
    ],
    '9072c432-711f-5e37-9545-4ff5fec4eb93' => [
        'Wise men talk because they have something to say; fools, because they have to say something.',
        'Plato',
    ],
    '9092e5af-1d0b-5d1e-8ea2-c0faeea67302' => [
        'Life is a great sunrise. I do not see why death should not be an even greater one.',
        'Elisabeth Kubler-Ross',
    ],
    '9099a1d8-4a3a-54e6-9664-fcd8320cc96e' => [
        'The ladder of success is best climbed by stepping on the rungs of opportunity.',
        'Ayn Rand',
    ],
    '9109a845-dd75-574f-8981-7290ef529f05' => [
        'I believe every chess player senses beauty, when he succeeds in creating situations, which contradict the expectations and the rules, and he succeeds in mastering this situation.',
        'Vladimir Kramnik',
    ],
    '9123bb11-d061-5c42-8f21-283374d28d3c' => [
    ...
    '9184f06e-7f39-59ef-9c3b-11ef93dea901' => [
        'Decision is a risk rooted in the courage of being free.',
        'Paul Tillich',
    ],
    '9187a8ec-1154-5d22-8aa3-74ec63f9a86c' => [
        'Success is not greedy, as people think, but insignificant. That is why it satisfies nobody.',
        'Lucius Annaeus Seneca',
    ],
    '9194bf38-d7c9-5ab3-ba06-ce9fd4acd6d2' => [
        'There is never enough time to do everything, but there is always enough time to do the most important thing.',
        'Brian Tracy',
    ],
    '9196f067-a153-5d99-b115-de0c71f69504' => [
    ...
    '9202b925-1821-5e0b-be92-0ff1323d0413' => [
        'People always say golfers don\'t smile. But there is so much psychology in golf so we have to be a bit robotic.',
        'Lee Westwood',
    ],
    '9208c7fe-c66d-586e-b661-5095b13a470c' => [
        'Romance and novel paint beauty in colors more charming than nature, and describe a happiness that humans never taste. How deceptive and destructive are those pictures of consummate bliss!',
        'Oliver Goldsmith',
    ],
    '9214d783-ed68-5e7f-a57e-6d5816397eae' => [
        'Since love grows within you, so beauty grows. For love is the beauty of the soul.',
        'Saint Augustine',
    ],
    '9233a4fb-2a67-5b43-8199-9522c30ee64c' => [
        'Our treasure lies in the beehive of our knowledge. We are perpetually on the way thither, being by nature winged insects and honey gatherers of the mind.',
        'Friedrich Nietzsche',
    ],
    '9239fec9-7823-53ff-b87d-7013b2973ecc' => [
        'We must walk consciously only part way toward our goal, and then leap in the dark to our success.',
        'Henry David Thoreau',
    ],
    '9270c9af-a8d5-5a39-b368-febb0f0607f0' => [
        'To find joy in work is to discover the fountain of youth.',
        'Pearl S. Buck',
    ],
    '9271b243-d246-55b2-b7c8-a7a5a7c1e6f8' => [
    ...
    '9279fe85-66b3-5e7e-a1d1-ab95fa6c2e6d' => [
        'You may delay, but time will not.',
        'Benjamin Franklin',
    ],
    '09314fa7-4a2f-53a8-9d11-ffbe276a7f79' => [
        'If you cannot smile when you listen to music, then do not listen to it!',
        'Estelle',
    ],
    '9320f167-4e06-5822-8a6c-1367461f13c0' => [
        'Yesterday is not ours to recover, but tomorrow is ours to win or lose.',
        'Lyndon B. Johnson',
    ],
    '9327bae5-f51f-501a-bd56-53c489cfe9dd' => [
    ...
    '9363a31b-41e2-50b1-919d-07b35bc1335f' => [
    ...
    '9372ea66-0a5f-5eab-ac60-5464d9af3f01' => [
        'Without hard work and discipline it is difficult to be a top professional.',
        'Jahangir Khan',
    ],
    '9386ef97-5d0b-5b36-917f-d078c66ff4b4' => [
        'Smile, it is the key that fits the lock of everybody\'s heart.',
        'Anthony J. D\'Angelo',
    ],
    '9391c19e-559f-5556-9780-0fb2e5533b3b' => [
        'A guitar is like an old friend that is there with me.',
        'B.B. King',
    ],
    '9404d8af-c96b-5e8d-b977-598561546641' => [
    ...
    '9444a7b5-b03e-52c3-85ad-ad350edaa7d3' => [
        'It is one of the most effective attitudes of the neurotic to measure thumbs down, so to speak, a real person by an ideal, since in doing so he can depreciate him as much as he wishes.',
        'Alfred Adler',
    ],
    '9529bfef-d1ae-58b5-bd26-736a1593c352' => [
    ...
    '9539fc0c-d006-530a-af3a-0d1e6c682b4c' => [
    ...
    '9555dd40-434f-5495-9d24-4db06ddf80b7' => [
        'Nothing beats a great smile.',
        'Karl Urban',
    ],
    '9618e2fd-02c3-5fcb-ad62-7e04605c4586' => [
    ...
    '9644b4fc-1a1e-5f22-a852-ab964ff55ac9' => [
        'It is better to be hated for what you are than to be loved for what you are not.',
        "Andr\u{e9} Gide",
    ],
    '9657e7fa-faba-59ac-9536-5ff5a7956797' => [
        'Between two evils, I always pick the one I never tried before.',
        'Mae West',
    ],
    '9659c7dc-080d-5126-92db-b9ba93055f86' => [
        'I don\'t think the world focuses on the positive things enough.',
        'Dwyane Wade',
    ],
    '9672a880-b0a8-5efb-998a-e8dc7a710778' => [
        'Beauty, n: the power by which a woman charms a lover and terrifies a husband.',
        'Ambrose Bierce',
    ],
    '9703abd2-e23a-58dc-92a5-0487a2581dee' => [
        'The first and most important step toward success is the feeling that we can succeed.',
        'Nelson Boswell',
    ],
    '9718e041-5bfe-5102-9bc6-eba34603e697' => [
        'If you have only one smile in you give it to the people you love.',
        'Maya Angelou',
    ],
    '9719d464-abd0-5718-8b34-d6c1dfebf0fd' => [
    ...
    '9773fe73-1f19-5dc8-91b1-9d549b225566' => [
    ...
    '9793de49-7d3b-579e-ae8e-fd80a0d5f376' => [
    ...
    '9793ee89-04c3-5ad0-8982-61ee19fb9a95' => [
        'In fact, I wouldn\'t really call this a Gospel album, I call it more an inspirational album.',
        'Smokey Robinson',
    ],
    '9804b313-387a-5550-9077-566ac9cd1d8d' => [
        'Either move or be moved.',
        'Ezra Pound',
    ],
    '9819b287-0c47-5964-8961-651d2943d72a' => [
    ...
    '09848c22-78d9-579f-9fe9-52aa482c7540' => [
        'The Amen of nature is always a flower.',
        'Oliver Wendell Holmes, Sr.',
    ],
    '9864f274-851c-558d-a9f1-c6a261caedd4' => [
    ...
    '9873db07-3fe4-557f-bbda-72484ff5a831' => [
        'How often I found where I should be going only by setting out for somewhere else.',
        'R. Buckminster Fuller',
    ],
    '9874ed4c-f556-5df5-9d06-ae8b2716e3d3' => [
        'You are not free until you have no need to impress anybody.',
        'Joyce Meyer',
    ],
    '9889a24f-c932-5152-8313-63308414973b' => [
